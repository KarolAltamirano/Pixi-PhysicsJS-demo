...
gulp.task('_css-build', function () {
    return gulp.src(cssFiles)
        .pipe(compass({
            http_path: BUILD_DIR + '/', // eslint-disable-line camelcase
            css: BUILD_DIR + '/css/',
            sass: 'src/scss/',
            ...
            import_path: [ // eslint-disable-line camelcase
...
gulp.task('_build', ['_css-build', '_css-vendor-build', '_js-main-build', '_js-header-build',
